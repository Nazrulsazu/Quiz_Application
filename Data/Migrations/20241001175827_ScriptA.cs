    ...
    public partial class ScriptA : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateTags", x => new { x.TagsId, x.TemplatesId });
                    table.ForeignKey(
                        name: "FK_TemplateTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateTags_Templates_TemplatesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateTags_TemplatesId",
                table: "TemplateTags",
                column: "TemplatesId");
        }
